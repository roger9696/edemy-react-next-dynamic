					...
					<div className="row">
						<div className="col-lg-8 col-md-12">
							<div className="purchase-guide-content">
								...
								<p>
									<i>
										This Purchase Guide was last updated on
										January 1, 2020.
									</i>
								</p>
								<h3>1. Our website</h3>
								...
								<p>
									In order to buy any course or become a
									member of our center, customers/ learners
									must first register with a personal account
