						...
						<div className="blog-details-desc">
							...
							<div className="article-content">
								...
								<p>
									...
									voluptatem sequi nesciunt. Neque porro quia
									non numquam eius modi tempora incidunt ut
									labore et dolore magnam dolor sit amet,
								...
								<p>
									...
									dolor in reprehenderit in sed quia non
								...
								<ul className="features-list">
									...
									<li>
										<i className="bx bx-badge-check"></i> A
										career overview opportunity available
									</li>
									<li>
										<i className="bx bx-badge-check"></i> A
										good work environment for work
									</li>
								</ul>
