			...
			<div className="container">
				<div className="section-title">
					...
					<p>
						...
						options can result in faster than the traditional ways.
				...
				<div className="row">
					<div className="col-lg-3 col-sm-6 col-md-6">
						<div className="single-features-box">
							...
							<p>
								Learning top skills can bring an extra-ordinary
								outcome in a career.
							</p>
					...
					<div className="col-lg-3 col-sm-6 col-md-6">
						<div className="single-features-box">
							...
							<p>
								Everyone prefers to enjoy learning at their own
					...
					<div className="col-lg-3 col-sm-6 col-md-6">
						<div className="single-features-box">
							...
							<p>
								We are delighted to give you options to enjoy
