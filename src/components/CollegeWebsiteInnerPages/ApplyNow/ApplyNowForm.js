          ...
          <form>
            ...
            <div className="row">
              <div className="col-lg-6">
                ...
                <div className="mb-3">
                  <label className="form-label">Select area of study</label>
                  <select
                    className="form-control"
                    aria-label="Default select example"
                  >
                    <option defaultValue="0">Select study area</option>
              ...
              <div className="col-lg-6">
                ...
                <div className="mb-3">
                  ...
                  <select
                    ...
                    aria-label="Default select example"
                  >
                    <option defaultValue="0">Select current status</option>
                    <option defaultValue="1">One</option>
                    <option defaultValue="2">Two</option>
                    <option defaultValue="3">Three</option>
                  </select>
                ...
                <div className="mb-3">
                  ...
                  <select
                    ...
                    aria-label="Default select example"
                  >
                    <option defaultValue="0">Select degree level</option>
                    <option defaultValue="1">One</option>
                    <option defaultValue="2">Two</option>
                    <option defaultValue="3">Three</option>
                  </select>
            ...
            <div className="mb-3 form-check">
              ...
              <label className="form-check-label" htmlFor="exampleCheck1">
                By submitting this form, you agree to the terms & conditions and
                ...
                <div className="col-lg-6">
                  ...
                  <div className="mb-3">
                    ...
                    <div className="form-text">
                      Photo must be in passport (PP) size, Max upload size 300KB
                    </div>
                  </div>
                </div>
              ...
              <div className="col-lg-6">
                ...
                <div className="mb-3">
                  ...
                  <select
                    ...
                    aria-label="Default select example"
                  >
                    <option defaultValue="0">Select student type</option>
                    <option defaultValue="1">One</option>
                    <option defaultValue="2">Two</option>
                    <option defaultValue="3">Three</option>
                  </select>
            ...
            <div className="mt-3">
              <button type="submit" className="default-btn cw-btn">
