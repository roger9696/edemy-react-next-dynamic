...
const AnnualTuitionFeesUndergraduate = () => {
  return (
    <>
      <div className="cw-annual-tuition-fees mb-4">
        <div className="container">
          <h2 className="title">Annual tuition fees (Undergraduate)</h2>
          ...
          <div className="table-responsive cw-annual-tuition-fees">
            <table className="table">
              ...
              <tbody>
                ...
                <tr>
                  <th scope="row">Diploma of information technology</th>
                  <td>$1,980</td>
                  <td>$3,800</td>
                </tr>
                <tr>
...
export default AnnualTuitionFeesUndergraduate;
