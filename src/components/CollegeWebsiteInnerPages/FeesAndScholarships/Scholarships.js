      ...
      <div className="ptb-100">
        <div className="container">
            ...
            <div className="col-lg-12 col-xl-6">
              <div className="cw-scholarships-content">
                ...
                <p>
                  ...
                  id enim. Curabitur aliquet quam id dui posuere blandit.
                ...
                <div className="cw-scholarships-list">
                  <div className="cw-list-card">
                    <h4>Merit aid:</h4>
                    <p>
                      Scholarships awarded based on academic merit. Amounts
                      range from $700 – $1000 annually
                    </p>
                  </div>
                  <div className="cw-list-card">
          ...
          <div className="cw-scholarships-pdf text-center">
            <p>
              Find more information on tuition fees, please download our{" "}
              <a href="#">PDF file</a>
            </p>
          </div>
        </div>
