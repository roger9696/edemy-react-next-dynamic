            ...
            <div className="col-lg-6">
              <div className="cw-accommodation-guarantee-img">
                ...
                <div className="cw-pdf-file d-flex align-items-center">
                  <img src="/images/college-website/icon9.png" alt="icon9" />
                  <p>
                    Need all information download <a href="#">PDF file</a>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-6">
              <div className="cw-accommodation-guarantee">
                ...
                <p>
                  ...
                  lectus nibh. Quisque velit nisi, pretium ut lacinia in,
                  elementum id enim. Nulla porttitor accumsan tincidunt. Sed
                ...
                <div className="row">
                  ...
                  <div className="col-sm-6">
                    <div className="cw-ag-list-card d-flex align-items-center">
                      ...
                      <h5 className="playfair-display-font">Book your room</h5>
                    </div>
                  </div>
                  <div className="col-sm-6">
                    <div className="cw-ag-list-card d-flex align-items-center">
