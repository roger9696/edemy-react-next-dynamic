          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="cw-halls-card">
                <h3 className="playfair-display-font">Residence management</h3>

                <p>
                  Praesent sapien massa, convallis a pellentesque nec, egestas
                  non nisi. Curabitur non nulla sit amet nisl tempus convallis
                  quis ac lectus. Lorem ipsum dolor sit amet, consectetur
                  adipiscing elit. Donec rutrum congue leo eget malesuada. Donec
                  rutrum congue leo eget malesuada. Pellentesque in ipsum id
                  orci porta dapibus.
                </p>
            ...
            <div className="col-lg-6">
              <div className="cw-halls-card">
                <h3 className="playfair-display-font">Safe and secure</h3>
