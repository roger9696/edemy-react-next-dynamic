		...
		<>
			<div className="motivation-subscribe-area bg-f9f9f9 ptb-100">
				...
				<div className="motivation-shape-7">
					<Image
						src="/images/motivation/motivation-shape-7.png"
						width={218}
						height={203}
						alt="image"
					/>
				...
				<div className="motivation-shape-8">
					<Image
						src="/images/motivation/motivation-shape-8.png"
						width={289}
						height={189}
						alt="image"
					/>
				...
				<div className="motivation-shape-9">
					<Image
						src="/images/motivation/motivation-shape-9.png"
						width={147}
						height={166}
						alt="image"
					/>
				...
				<div className="motivation-shape-10">
					<Image
						src="/images/motivation/motivation-shape-10.png"
						width={175}
						height={274}
						alt="image"
					/>
